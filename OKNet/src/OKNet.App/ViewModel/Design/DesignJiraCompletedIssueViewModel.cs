    ...
    public class DesignJiraCompletedIssueViewModel : JiraCompletedIssueViewModel
    {
        public DesignJiraCompletedIssueViewModel()
        {
            ...
            AddOrUpdateNewIssues(new List<IssueViewModel>
            {
                ...
                new IssueViewModel { Updated=GetUtcDropoff(), Key = "OKNET-Common", Name = "Develop configuration viewmodel base for kiosk settings", ProjectId = 3, Component = new ObservableCollection<ComponentViewModel> {new ComponentViewModel {Name = "WPF", Id = 3} } }
            });
